( () => {
        ...
        for (let s = 1; s < arguments.length; s += 1) {
            ...
            if (null != i && !b(i)) {
                ...
                for (let t = 0, n = s.length; t < n; t += 1) {
                    ...
                    void 0 !== a && a.enumerable && (w(e[n]) && w(i[n]) ? i[n].__swiper__ ? e[n] = i[n] : C(e[n], i[n]) : !w(e[n]) && w(i[n]) ? (e[n] = {},
        ...
        updateSlides: function() {
            ...
            for (let n = 0; n < p; n += 1) {
                ...
                "none" !== r.css("display")) {
                    ...
                    f.push(x),
                    i.centeredSlides ? (C = C + x / 2 + T / 2 + b,
                    0 === T && 0 !== n && (C = C - a / 2 - b),
                    0 === n && (C = C - a / 2 - b),
                    Math.abs(C) < .001 && (C = 0),
    ...
    function D(e) {
        ...
        if (l.noSwiping && (h ? function(e, t) {
            ...
            function t(s) {
                return s && s !== n() && s !== r() ? (s.assignedSlot && (s = s.assignedSlot),
        ...
        "touchstart" !== c.type) {
            ...
            s.activeElement && f(s.activeElement).is(a.focusableElements) && s.activeElement !== p[0] && s.activeElement.blur();
    ...
    function G(e) {
        ...
        if (void 0 === i.isScrolling) {
            let e;
            s.isHorizontal() && r.currentY === r.startY || s.isVertical() && r.currentX === r.startX ? i.isScrolling = !1 : h * h + m * m >= 25 && (e = 180 * Math.atan2(Math.abs(m), Math.abs(h)) / Math.PI,
        ...
        a.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + v) ** b)) : v < 0 && i.currentTranslate < s.maxTranslate() && (w = !1,
        a.resistance && (i.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - i.startTranslate - v) ** b)),
    ...
    const V = (e, t) => {
        ...
        if (d.touch) {
            ...
            r[p](a.move, e.onTouchMove, d.passiveListener ? {
                passive: !1,
                capture: c
            } : c),
    ...
    const W = {
        attachEvents: function() {
            ...
            e.onClick = _.bind(e),
            i.touch && !F && (t.addEventListener("touchstart", H),
            F = !0),
            V(e, "on")
        },
    ...
    function se(e, t, s) {
        ...
        let a = n.children(`.${i}`);
        return a.length || (a = f(`<div class="swiper-slide-shadow${s ? `-${s}` : ""}"></div>`),
        n.append(a)),
        a
    }
    function ie(e, t) {
    ...
    , function(e) {
        let t, s, i, {swiper: n, extendParams: a} = e;
        a({
            grid: {
                rows: 1,
                fill: "column"
        ...
        n.grid = {
            ...
            updateWrapperSize: (e, s, i) => {
                const {spaceBetween: a, centeredSlides: r, roundLengths: l} = n.params
        ...
        function(e) {
            ...
            setTranslate: () => {
                ...
                for (let e = 0, t = i.length; e < t; e += 1) {
                    const t = i.eq(e)
                      , s = n[e]
                      , l = (o - t[0].swiperSlideOffset - s / 2) / s * a.modifier;
                    let p = r ? d * l : 0
                      , u = r ? 0 : d * l
                      , h = -c * Math.abs(l)
                      , f = a.stretch;
                    "string" == typeof f && -1 !== f.indexOf("%") && (f = parseFloat(a.stretch) / 100 * s);
                    let m = r ? 0 : f * l
                      , g = r ? f * l : 0
                      , v = 1 - (1 - a.scale) * Math.abs(l);
                    Math.abs(g) < .001 && (g = 0),
                    Math.abs(m) < .001 && (m = 0),
                    Math.abs(h) < .001 && (h = 0),
                    Math.abs(p) < .001 && (p = 0),
                    ...
                    a.slideShadows) {
                        ...
                        0 === e.length && (e = se(a, t, r ? "left" : "top")),
                        0 === s.length && (s = se(a, t, r ? "right" : "bottom")),
    ...
    , function(e) {
        ...
        function c() {
            ...
            if ("fraction" === s.type && (a.find(te(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
            ...
            "progressbar" === s.type) {
                ...
                a.find(te(s.progressbarFillClass)).transform(`translate3d(0,0,0) scaleX(${n}) scaleY(${r})`).transition(t.params.speed)
            }
        ...
        function u() {
            ...
            s.length > 1 && (s = s.filter((e => f(e).parents(".swiper")[0] === t.el)))),
            ...
            e.clickable && s.on("click", te(e.bulletClass), (function(e) {
                e.preventDefault();
    ...
    function le() {
        var e = document.querySelector(".testimonials .container");
        window.innerWidth >= 1199.98 ? e.style.marginLeft = "".concat(function(e) {
            return parseInt(window.getComputedStyle(document.querySelector(e)).marginLeft) + parseInt(window.getComputedStyle(document.querySelector(e)).paddingLeft)
        }(".header .container"), "px") : e.style.marginLeft = "auto"
    }
    document.addEventListener("DOMContentLoaded", (function() {
        var e, t, s;
        e = ".testimonials_slider",
        t = ".testimonials_controls",
        s = {
            slidesPerView: 1,
            spaceBetween: 30,
            autoplay: !0,
        ...
        document.querySelector(e) && new Z(e,ae(ae({}, re), {}, {
            pagination: {
